...
router.post(
  ...
  async (req, res, next) => {
    ...
    let result = await pool.execute(
      'INSERT INTO used_product (name, category_room, category_product, amount, description, original_price, price, img, bought_in, created_at, updated_at, valid, seller_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)',
      [
        req.body.name,
        req.body.categoryRoom,
        req.body.categoryProduct,
        req.body.amount,
